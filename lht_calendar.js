...
function calCaption(calDate) {
   ...
   function calWeekdayRow() {
      ...
      rowHTML += "</tr>";
      // return statement to pass rowHTML to wherever callWeekdayRow was called
      return rowHTML;
   }
   ...
   function calDays(calDate) {
      ...
      for(var i = 1; i <= totalDays; i++) {
         ...
         // Check the weekDay variable to figure out if the week is starting new or ending
         if(weekDay ===  0) {
            htmlCode += "<tr>";
         }
